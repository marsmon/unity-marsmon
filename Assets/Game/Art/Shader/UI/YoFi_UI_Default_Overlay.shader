...
Shader "YoFi/UI/Default_Overlay"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            #include "Assets/Game/Art/Shader/Common/Included/Functions.hlsl"
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                color.a *= IN.color.a;
                color.rgb = BlendMode_Overlay(color.rgb,IN.color.rgb);

                
                // #ifndef UNITY_COLORSPACE_GAMMA
                //     color.rgb = LinearToGammaSpace(color.rgb);
                //     color.a = LinearToGammaSpace(color.a);
                // #endif
