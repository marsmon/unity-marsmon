//guid: 50c7ac9c667727f44974b1f6e95472bc
Shader "YoFi/Effect/Dissolution_Base" {
    Properties {
        [HideInInspector]
        _mode("__Mode",float)= 2050 
        ...
        _Effect0Value("mv",vector) = (1,0,1,1)
