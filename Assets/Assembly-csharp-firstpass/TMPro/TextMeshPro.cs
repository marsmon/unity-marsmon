...
namespace TMPro
{
	[AddComponentMenu("Mesh/TextMesh Pro"), ExecuteInEditMode, RequireComponent(typeof(TextContainer)), RequireComponent(typeof(MeshRenderer)), RequireComponent(typeof(MeshFilter))]
