...
public class DebugHelper : MonoBehaviour
{
	...
	[Conditional("UNITY_STANDALONE_WIN"), Conditional("UNITY_EDITOR"), Conditional("UNITY_IPHONE"), Conditional("FORCE_LOG"), Conditional("UNITY_ANDROID")]
	public static void Assert(bool InCondition)
	{
		DebugHelper.Assert(InCondition, null, null);
	}

	[Conditional("UNITY_ANDROID"), Conditional("UNITY_EDITOR"), Conditional("UNITY_IPHONE"), Conditional("FORCE_LOG"), Conditional("UNITY_STANDALONE_WIN")]
	...
	[Conditional("FORCE_LOG"), Conditional("UNITY_IPHONE"), Conditional("UNITY_ANDROID"), Conditional("UNITY_EDITOR"), Conditional("UNITY_STANDALONE_WIN")]
