...
public class SceneMgr : MonoSingleton<SceneMgr>
{
	...
	{
		SceneMgr.<PreloadCommonAssets>c__IteratorE <PreloadCommonAssets>c__IteratorE = new SceneMgr.<PreloadCommonAssets>c__IteratorE();
		<PreloadCommonAssets>c__IteratorE.<>f__this = this;
		return <PreloadCommonAssets>c__IteratorE;
	}

	[DebuggerHidden]
	public IEnumerator PreloadCommonEffects()
	{
		SceneMgr.<PreloadCommonEffects>c__IteratorF <PreloadCommonEffects>c__IteratorF = new SceneMgr.<PreloadCommonEffects>c__IteratorF();
		<PreloadCommonEffects>c__IteratorF.<>f__this = this;
		return <PreloadCommonEffects>c__IteratorF;
	}
	...
	{
		return new SceneMgr.<UnloadAssets_Coroutine>c__Iterator10();
	}
