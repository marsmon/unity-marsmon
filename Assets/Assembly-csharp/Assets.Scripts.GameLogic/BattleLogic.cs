...
namespace Assets.Scripts.GameLogic
{
	public class BattleLogic : Singleton<BattleLogic>, IUpdateLogic
	{
		...
		private void SendSecureStartInfoReq()
		{
			...
			{
				stSecureInfoStartReq.iSvrBossHPMax = ((stSecureInfoStartReq.iSvrBossHPMax <= list.get_Item(i).handle.ValueComponent.actorHp) ? list.get_Item(i).handle.ValueComponent.actorHp : stSecureInfoStartReq.iSvrBossHPMax);
				...
				{
					stSecureInfoStartReq.iSvrBossHPMin = ((stSecureInfoStartReq.iSvrBossHPMin >= list.get_Item(i).handle.ValueComponent.actorHp) ? list.get_Item(i).handle.ValueComponent.actorHp : stSecureInfoStartReq.iSvrBossHPMin);
				}
