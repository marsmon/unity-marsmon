...
namespace Assets.Scripts.GameLogic
{
	public class DialogueProcessor : MonoSingleton<DialogueProcessor>
	{
		...
		{
			DialogueProcessor.<NextPageNoTimeScale>c__Iterator11 <NextPageNoTimeScale>c__Iterator = new DialogueProcessor.<NextPageNoTimeScale>c__Iterator11();
		...
		{
			DialogueProcessor.<StartFadingOut>c__Iterator13 <StartFadingOut>c__Iterator = new DialogueProcessor.<StartFadingOut>c__Iterator13();
		...
		{
			DialogueProcessor.<StartFadingIn>c__Iterator14 <StartFadingIn>c__Iterator = new DialogueProcessor.<StartFadingIn>c__Iterator14();
