...
namespace Assets.Scripts.Framework
{
	...
	public class Reconnection : MonoSingleton<Reconnection>, IGameModule
	{
		...
		{
			Reconnection.<ProcessRelaySyncCache>c__IteratorD <ProcessRelaySyncCache>c__IteratorD = new Reconnection.<ProcessRelaySyncCache>c__IteratorD();
			<ProcessRelaySyncCache>c__IteratorD.<>f__this = this;
			return <ProcessRelaySyncCache>c__IteratorD;
		}
