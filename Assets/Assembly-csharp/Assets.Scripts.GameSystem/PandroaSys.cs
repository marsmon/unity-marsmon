...
namespace Assets.Scripts.GameSystem
{
	public class PandroaSys : MonoSingleton<PandroaSys>
	{
		...
		{
			PandroaSys.<DeleteAddImage>c__Iterator2D <DeleteAddImage>c__Iterator2D = new PandroaSys.<DeleteAddImage>c__Iterator2D();
			<DeleteAddImage>c__Iterator2D.imgObj = imgObj;
			<DeleteAddImage>c__Iterator2D.path = path;
			<DeleteAddImage>c__Iterator2D.<$>imgObj = imgObj;
			<DeleteAddImage>c__Iterator2D.<$>path = path;
			return <DeleteAddImage>c__Iterator2D;
		}
