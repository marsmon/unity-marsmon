			...
			while (enumerator.MoveNext())
			{
				...
				if (flag)
				{
					...
					while (enumerator2.MoveNext() && num <= 3)
					{
						...
						CSingleGameSettleView.SetPlayerStat(form, arg_122_1, current4.get_Value(), enumerator2.Current);
						num++;
					}
					int arg_154_0 = num3;
				...
				else
				{
					...
					while (enumerator3.MoveNext() && num2 <= 3)
					{
						...
						CSingleGameSettleView.SetPlayerStat(form, arg_1FD_1, current10.get_Value(), enumerator3.Current);
						num2++;
					}
					int arg_230_0 = num4;
