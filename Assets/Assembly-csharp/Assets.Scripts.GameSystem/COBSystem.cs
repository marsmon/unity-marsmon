...
namespace Assets.Scripts.GameSystem
{
	...
	public class COBSystem : Singleton<COBSystem>
	{
		...
		public void RefreshListContentSize(CUIListScript list)
		{
			if (list == null)
			{
				return;
			}
			RectTransform rectTransform = list.m_scrollRect.transform as RectTransform;
			list.m_scrollAreaSize = new Vector2(rectTransform.rect.width, rectTransform.rect.height);
		}
		...
		public void UpdateView()
		{
			...
			CUIListScript component = componetInChild2.GetComponent<CUIListScript>();
			RectTransform component2 = Utility.FindChild(componetInChild2.gameObject, "ScrollRect").GetComponent<RectTransform>();
			...
			if (curTab == COBSystem.enOBTab.Expert)
			{
				...
				this.RefreshListContentSize(component);
			}
			...
			else if (curTab == COBSystem.enOBTab.Local)
			{
				...
				component2.sizeDelta = COBSystem.s_content_size;
				component2.anchoredPosition = COBSystem.s_content_pos;
