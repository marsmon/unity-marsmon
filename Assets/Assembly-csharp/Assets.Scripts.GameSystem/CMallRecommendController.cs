...
namespace Assets.Scripts.GameSystem
{
	...
	public class CMallRecommendController : Singleton<CMallRecommendController>
	{
		...
		private void RefreshSkillPanel(ResHeroCfgInfo heroCfg)
		{
			...
			cUIListScript.SetElementAmount(4);
			for (int i = 0; i < 4; i++)
			{
				CUIListElementScript elemenet = cUIListScript.GetElemenet(i);
				GameObject gameObject2 = elemenet.gameObject.transform.Find("heroSkillItemCell").gameObject;
				int iSkillID = heroCfg.astSkill[i].iSkillID;
				...
				GameObject gameObject3 = gameObject2.transform.Find("skillMask/skillIcon").gameObject;
				...
				eventParams.skillTipParam.strTipText = CUICommonSystem.GetSkillDescLobby(skillCfgInfo.szLobbySkillDesc, heroCfg.dwCfgID);
