...
namespace Assets.Scripts.GameSystem
{
	public class CVersionUpdateSystem : MonoSingleton<CVersionUpdateSystem>
	{
		...
		{
			CVersionUpdateSystem.<CheckFirstExtractResource>c__Iterator34 <CheckFirstExtractResource>c__Iterator = new CVersionUpdateSystem.<CheckFirstExtractResource>c__Iterator34();
		...
		{
			CVersionUpdateSystem.<VersionUpdateComplete>c__Iterator35 <VersionUpdateComplete>c__Iterator = new CVersionUpdateSystem.<VersionUpdateComplete>c__Iterator35();
