...
namespace Assets.Scripts.GameSystem
{
	public class CBattleEquipSystem
	{
		...
		public bool IsEquipCanBought(ushort equipID, ref PoolObjHandle<ActorRoot> actor, ref CBattleEquipSystem.CEquipBuyPrice equipBuyPrice)
		{
			...
			return (ulong)actor.handle.ValueComponent.GetGoldCoinInBattle() >= (ulong)((long)equipBuyPrice.m_buyPrice) && actor.handle.EquipComponent.IsEquipCanAddedToGrid(equipID, ref equipBuyPrice);
		}
