	...
	public class IDIPSys : MonoSingleton<IDIPSys>
	{
		...
		private void CheckIsBtnUrl(IDIPSys.IDIPData data)
		{
			...
			if (num > 0)
			{
				...
				{
					data.btnDoSth = IDIPSys.BTN_DOSOMTHING.BTN_DOSOMTHING_URL_APPEND;
				}
				else
				{
		...
		{
			IDIPSys.<GetChannelID>c__Iterator2A <GetChannelID>c__Iterator2A = new IDIPSys.<GetChannelID>c__Iterator2A();
			<GetChannelID>c__Iterator2A.<>f__this = this;
			return <GetChannelID>c__Iterator2A;
		}
		...
		{
			IDIPSys.<DownloadImage>c__Iterator2B <DownloadImage>c__Iterator2B = new IDIPSys.<DownloadImage>c__Iterator2B();
			<DownloadImage>c__Iterator2B.preUrl = preUrl;
			<DownloadImage>c__Iterator2B.checkDays = checkDays;
			<DownloadImage>c__Iterator2B.callBack = callBack;
			<DownloadImage>c__Iterator2B.<$>preUrl = preUrl;
			<DownloadImage>c__Iterator2B.<$>checkDays = checkDays;
			<DownloadImage>c__Iterator2B.<$>callBack = callBack;
			<DownloadImage>c__Iterator2B.<>f__this = this;
			return <DownloadImage>c__Iterator2B;
		}
		...
		{
			IDIPSys.<DownloadImageByTag>c__Iterator2C <DownloadImageByTag>c__Iterator2C = new IDIPSys.<DownloadImageByTag>c__Iterator2C();
			<DownloadImageByTag>c__Iterator2C.preUrl = preUrl;
			<DownloadImageByTag>c__Iterator2C.tagPath = tagPath;
			<DownloadImageByTag>c__Iterator2C.checkDays = checkDays;
			<DownloadImageByTag>c__Iterator2C.callBack = callBack;
			<DownloadImageByTag>c__Iterator2C.ImageIDx = ImageIDx;
			<DownloadImageByTag>c__Iterator2C.<$>preUrl = preUrl;
			<DownloadImageByTag>c__Iterator2C.<$>tagPath = tagPath;
			<DownloadImageByTag>c__Iterator2C.<$>checkDays = checkDays;
			<DownloadImageByTag>c__Iterator2C.<$>callBack = callBack;
			<DownloadImageByTag>c__Iterator2C.<$>ImageIDx = ImageIDx;
			<DownloadImageByTag>c__Iterator2C.<>f__this = this;
			return <DownloadImageByTag>c__Iterator2C;
		}
		...
		private void OnBtnComplete(CUIEvent ciEvent)
		{
			if (this.m_CurSelectData != null && this.m_bShow)
			{
				...
				else if (curSelectData.btnDoSth == IDIPSys.BTN_DOSOMTHING.BTN_DOSOMTHING_URL_APPEND)
				{
					string text = curSelectData.btnUrl;
					if (!text.Contains("?"))
					{
						text = text + "?" + CLobbySystem.GetAppendUrlParam();
					}
					else
					{
						text = text + "&" + CLobbySystem.GetAppendUrlParam();
					}
					Debug.Log("idip btn url " + text);
