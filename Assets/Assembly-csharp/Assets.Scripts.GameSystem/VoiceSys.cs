...
namespace Assets.Scripts.GameSystem
{
	...
	public class VoiceSys : MonoSingleton<VoiceSys>
	{
		...
		{
			VoiceSys.<UpdateEnterRoomState>c__Iterator3C <UpdateEnterRoomState>c__Iterator3C = new VoiceSys.<UpdateEnterRoomState>c__Iterator3C();
			<UpdateEnterRoomState>c__Iterator3C.<>f__this = this;
			return <UpdateEnterRoomState>c__Iterator3C;
		}
