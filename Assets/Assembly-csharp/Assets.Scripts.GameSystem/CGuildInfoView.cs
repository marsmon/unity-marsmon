...
namespace Assets.Scripts.GameSystem
{
	public class CGuildInfoView : Singleton<CGuildInfoView>
	{
		...
		private void On_Guild_Guild_Setting_Confirm(CUIEvent uiEvent)
		{
			...
			int arg2;
			if (!int.TryParse(component3.text, ref arg2))
			{
			...
			int arg3;
			if (!int.TryParse(component4.text, ref arg3))
			{
		...
		private void On_Guild_Setting_Down_Join_Grade(CUIEvent uiEvent)
		{
			...
			int inShowGrade;
			if (int.TryParse(component.text, ref inShowGrade))
			{
		...
		private void On_Guild_Application_Reject(CUIEvent uiEvent)
		{
			...
			Text component2 = elemenet.transform.Find("txtUidData").GetComponent<Text>();
			ulong arg;
			if (ulong.TryParse(component2.text, ref arg))
			{
		...
		private void On_Guild_Recommend_Invite(CUIEvent uiEvent)
		{
			...
			ulong num;
			int arg;
			if (ulong.TryParse(component2.text, ref num) && int.TryParse(component3.text, ref arg))
			{
		...
		private void On_Guild_Recommend_Reject(CUIEvent uiEvent)
		{
			...
			ulong arg;
			int arg2;
			if (ulong.TryParse(component2.text, ref arg) && int.TryParse(component3.text, ref arg2))
			{
		...
		private void OnQueryPlatformGroupInfoNotify(ApolloGroupResult groupRet)
		{
			...
			if (groupRet.result == ApolloResult.Success)
			{
				...
				if (this.m_needSendRemindMsg)
				{
					...
					Singleton<CGuildInfoController>.GetInstance().SendPlatformGroupLog(enPlatformGroupStatus, this.m_Model.CurrentGuildInfo.groupOpenId);
				}
			}
			else
			{
		...
		{
			CGuildInfoView.<UnLinkWxGroup>c__Iterator29 <UnLinkWxGroup>c__Iterator = new CGuildInfoView.<UnLinkWxGroup>c__Iterator29();
