...
namespace Assets.Scripts.GameSystem
{
	...
	public class CHeroInfoSystem2 : Singleton<CHeroInfoSystem2>
	{
		...
		public void OnHeroSkin_ItemSelect(CUIEvent uiEvent)
		{
			...
			{
				ResHeroSkin heroSkin = CSkinInfo.GetHeroSkin(this.m_selectHeroID, CSkinInfo.GetSkinIdByIndex(this.m_selectHeroID, i));
				CUIListElementScript elemenet = component.GetElemenet(i);
				if (elemenet != null)
				{
					this.SetSkinListItem(elemenet.gameObject, heroSkin, i == selectedIndex);
				}
			}
			uint skinIdByIndex = CSkinInfo.GetSkinIdByIndex(this.m_selectHeroID, selectedIndex);
