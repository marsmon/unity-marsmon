...
public class Utility
{
	...
	public static string ProtErrCodeToStr(int ProtId, int ErrCode)
	{
			...
			case 1909:
				...
				case 5407:
					...
					case 223:
						...
						goto IL_51B;
					case 227:
						result = Singleton<CTextManager>.GetInstance().GetText("CS_ERR_DATINGDECLARATION_ILLEGAL");
						goto IL_51B;
					case 228:
						result = Singleton<CTextManager>.GetInstance().GetText("CS_ERR_FRIENDCARD_TAG");
						goto IL_51B;
					case 229:
						result = Singleton<CTextManager>.GetInstance().GetText("CS_ERR_FRIENDCARD_OTHER");
						goto IL_51B;
					case 230:
						result = Singleton<CTextManager>.GetInstance().GetText("CS_ERR_CHG_ANTIDISTURB_BIT");
						goto IL_51B;
					case 232:
						result = Singleton<CTextManager>.GetInstance().GetText("CS_ERR_STUDENT_GRADE_HIGH");
						goto IL_51B;
					case 233:
						result = Singleton<CTextManager>.GetInstance().GetText("CS_ERR_STUDENT_GRADE_LOW");
						goto IL_51B;
					}
								...
								case 1177:
									...
									case 1833:
										...
										case 14:
											...
											break;
										case 16:
											result = Singleton<CTextManager>.GetInstance().GetText("CS_PRESENTHEROSKIN_HASHERO");
											break;
										case 17:
											result = Singleton<CTextManager>.GetInstance().GetText("CS_PRESENTHEROSKIN_HASSKIN");
											break;
										}
										return result;
									case 1832:
										...
										case 4803:
											...
											if (ProtId == 1051)
											{
												...
												case 11:
													...
													break;
												case 12:
													result = Singleton<CTextManager>.GetInstance().GetText("CS_SINGLEGAME_ERR_EXPSKIN");
													break;
												case 13:
													result = Singleton<CTextManager>.GetInstance().GetText("Arena_Be_Chanllenge_Time_Protect");
													break;
												}
												return result;
											}
		...
		{
		case 1:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_SYS");
			break;
		case 2:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_INDEX");
			break;
		case 3:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_UNDEL");
			break;
		case 4:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_VERSION");
			break;
		case 5:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_NODATA");
			break;
		case 6:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_STATE");
			break;
		case 7:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_MSGDIRTY");
			break;
		case 8:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_LOCK");
			break;
		case 9:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_SELF");
			break;
		case 10:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_MAXCNT");
			break;
		case 11:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_PLAT");
			break;
		case 12:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_ITEM");
			break;
		case 13:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_NOFRIEND");
			break;
		case 14:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_NOALLOW");
			break;
		case 15:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_READWAIT");
			break;
		case 16:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_MSGTYPE");
			break;
		case 17:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_MSGID");
			break;
		case 18:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_PSWDCHK");
			break;
		case 19:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_OFFSHELF");
			break;
		case 20:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_PAY");
			break;
		case 21:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_COINLIMIT");
			break;
		case 22:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_MAILFAIL");
			break;
		case 23:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_NOOPEN");
			break;
		case 24:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_FRIENDTIME");
			break;
		case 25:
			result = Singleton<CTextManager>.GetInstance().GetText("CS_ACNT_ASKFORREQ_ERR_ITEMHAVE");
			break;
		}
		return result;
	}
