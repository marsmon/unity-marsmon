...
namespace Assets.Scripts.UI
{
	public class CUIHttpImageScript : CUIComponent
	{
		...
		{
			CUIHttpImageScript.<DownloadImage>c__Iterator3A <DownloadImage>c__Iterator3A = new CUIHttpImageScript.<DownloadImage>c__Iterator3A();
			<DownloadImage>c__Iterator3A.url = url;
			<DownloadImage>c__Iterator3A.<$>url = url;
			<DownloadImage>c__Iterator3A.<>f__this = this;
			return <DownloadImage>c__Iterator3A;
		}
	}
}
