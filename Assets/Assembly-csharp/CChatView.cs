...
public class CChatView
{
	...
	public void BuildTabList(List<uint> list, int index = 0)
	{
		...
		for (int i = 0; i < this.listScript.m_elementAmount; i++)
		{
			...
			component2.text = Singleton<CTextManager>.instance.GetText(CChatUT.GetEChatChannel_Text((EChatChannel)list.get_Item(i)));
		}
	...
	public void ReBuildTabText()
	{
		...
		for (int i = 0; i < this.curChannels.get_Count(); i++)
		{
			...
			component.text = Singleton<CTextManager>.instance.GetText(CChatUT.GetEChatChannel_Text((EChatChannel)this.curChannels.get_Item(i)));
		}
	}
