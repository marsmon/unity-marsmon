...
namespace com.tencent.pandora
{
	public class ResourceMgr
	{
		...
		{
			ResourceMgr.<LoadLuaAssetBundle>c__Iterator37 <LoadLuaAssetBundle>c__Iterator = new ResourceMgr.<LoadLuaAssetBundle>c__Iterator37();
		...
		{
			ResourceMgr.<CreatePanel>c__Iterator38 <CreatePanel>c__Iterator = new ResourceMgr.<CreatePanel>c__Iterator38();
