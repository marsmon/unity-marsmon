			...
			for (int i = 0; i < count; i++)
			{
				...
				if (!string.IsNullOrEmpty(value2))
				{
					...
					if (num > -1)
					{
						...
						{
							int num3 = Convert.ToInt32(match.Groups[3].ToString());
							int num4 = Convert.ToInt32(match.Groups[4].ToString());
							string text3 = Convert.ToString(match.Groups[5]);
							string text4 = Utility.CreateMD5Hash(string.Format("{0}{1}{2}", num3, num4, "j9cWiS6lPjw4g"), Utility.MD5_STRING_CASE.LOWER);
							if (text3 == text4)
							{
