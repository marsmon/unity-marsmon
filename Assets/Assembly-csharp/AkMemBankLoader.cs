...
public class AkMemBankLoader : MonoBehaviour
{
	...
	{
		AkMemBankLoader.<LoadFile>c__Iterator3D <LoadFile>c__Iterator3D = new AkMemBankLoader.<LoadFile>c__Iterator3D();
		<LoadFile>c__Iterator3D.<>f__this = this;
		return <LoadFile>c__Iterator3D;
	}
