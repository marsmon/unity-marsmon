...
namespace RenderHeads.Media.AVProVideo.Demos
{
	public class MediaPlayerUI : MonoBehaviour
	{
		...
		void Start()
		{
            ...
            _mediaPlayer.OpenMedia(MediaPathType.RelativeToStreamingAssetsFolder, "AVProVideoSamples/BigBuckBunny-360p30-H264.mp4", true);
#elif UNITY_ANDROID
            _mediaPlayer.OpenMedia(MediaPathType.AbsolutePathOrURL, $"{Application.persistentDataPath}/Video/BigBuckBunny-360p30-H264.mp4", true);
#endif
        }
