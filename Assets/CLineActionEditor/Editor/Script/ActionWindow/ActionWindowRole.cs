...
namespace SuperCLine.ActionEngine.Editor
{
    ...
    internal sealed partial class ActionWindow
    {
        ...
        {
            SerializeProperty<PlayerProperty>(ResourceMgr.gamedataPath + "Unit/Player.json", actorPlayerTree);
            SerializeProperty<MonsterProperty>(ResourceMgr.gamedataPath + "Unit/Monster.json", actorMonsterTree);
