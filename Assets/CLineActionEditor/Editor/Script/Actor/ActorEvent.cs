    ...
    internal class ActorEvent : Actor
    {
        ...
        public EEventStyle eventStyle
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    leftHandle.Init(this, EEventHandleType.Left);
                    rightHandle = new ActorEventHandle();
                    rightHandle.Init(this, EEventHandleType.Right);
        ...
        public void DrawInspectorInterrupt()
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                parent?.OnChangeTrackName(interrupt.InterruptName);
            }
            ...
            window.DrawActionInterrupt(eventProperty.EventData as ActionInterrupt, false);
        }
